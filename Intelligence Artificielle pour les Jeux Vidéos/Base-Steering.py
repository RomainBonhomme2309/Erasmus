...
__circuit__ = (
    (100, 800),   # Virage 1 - La Source
    (150, 650),   # Virage 2 - Début de la descente vers Eau Rouge
    (200, 500),   # Virage 3 - Eau Rouge
    (250, 400),   # Virage 4 - Raidillon
    (300, 300),   # Virage 5 - Ligne droite de Kemmel
    (400, 250),   # Virage 6 - Les Combes
    (500, 350),   # Virage 7 - Bruxelles
    (550, 450),   # Virage 8 - Double gauche
    (600, 500),   # Virage 9
    (650, 550),   # Virage 10
    (700, 500),   # Virage 11
    (800, 400),   # Virage 12
    ...
    (900, 300),   # Virage 14
    (950, 350),   # Virage 15
    (1000, 400),  # Virage 16 - Campus
    (1100, 500),  # Virage 17 - Stavelot
    (1200, 600),  # Virage 18
    (1300, 700),  # Virage 19 - Blanchimont
    (1400, 800),  # Virage 20 - Chicane et Ligne d'arrivée
)

__screenSize__ = (1800, 900)
